...
class Config:
    ...
    ENABLE_PREDICTIVE_SAFETY_RESIDUAL = False
    PREDICTIVE_SAFETY_HORIZON_STEPS = 10
    PREDICTIVE_SAFETY_DT = 0.1
    PREDICTIVE_SAFETY_USE_CANDIDATES = True
    PREDICTIVE_SAFETY_RESIDUAL_SCALE = 0.3
    PREDICTIVE_SAFETY_REG_COEFF = 0.0
    PREDICTIVE_SAFETY_GEN_PENALTY = 0.0
    PREDICTIVE_SAFETY_GEN_PENALTY_START_EPOCH = 270
    PREDICTIVE_SAFETY_GEN_PENALTY_THRESHOLD = 0.7
    PREDICTIVE_SAFETY_GEN_PENALTY_CLIP_MIN = -0.03
    PREDICTIVE_SAFETY_GEN_PENALTY_CLIP_MAX = 0.0
    PREDICTIVE_SAFETY_GEN_PENALTY_SOURCE = "q_safe_risk"
    PREDICTIVE_SAFETY_REG_MODE = "predictive_candidate_ranking"
    PREDICTIVE_SAFETY_REG_MARGIN = 0.2
    PREDICTIVE_SAFETY_BASE_REG_COEFF = None
    PREDICTIVE_SAFETY_LATE_REG_EPOCH = None
    PREDICTIVE_SAFETY_LATE_REG_COEFF = None
    PREDICTIVE_SAFETY_RAMP_REG_START_EPOCH = None
    PREDICTIVE_SAFETY_RAMP_REG_END_EPOCH = None
    PREDICTIVE_SAFETY_ENABLE_CPAIR_ADDITIVE = False
    PREDICTIVE_SAFETY_CPAIR_ADDITIVE_START_EPOCH = 260
    PREDICTIVE_SAFETY_CPAIR_ADDITIVE_COEFF = 0.0
    PREDICTIVE_SAFETY_CANDIDATE_SET = "current"
    PREDICTIVE_SAFETY_SAFE_SELECTION = "min_risk"
    PREDICTIVE_SAFETY_RANK_METRIC = "clipped"
    PREDICTIVE_SAFETY_FOCUSED_CPAIR_ENABLE = False
    PREDICTIVE_SAFETY_FOCUSED_CPAIR_MIN_GAP = 0.10
    PREDICTIVE_SAFETY_FOCUSED_CPAIR_MIN_POLICY_RISK = 0.30
    PREDICTIVE_SAFETY_FOCUSED_CPAIR_WEIGHT_CLIP = 0.20
    PREDICTIVE_SAFETY_FOCUSED_CPAIR_WEIGHT_SOURCE = "raw"
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_ENABLE = False
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_START_EPOCH = 270
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_COEFF = 0.0
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_CANDIDATE_SET = "candidate_v2_leadaware"
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_SAFE_SELECTION = "task_safe"
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_RANK_METRIC = "clipped"
    PREDICTIVE_SAFETY_LATE_TINY_CPAIR_MARGIN = 0.1
    PROBE_FULL_EVAL_FREQ_EPOCHS = 5
    PROBE_FULL_EVAL_PRE_END_EPOCH = 200
    PROBE_FULL_EVAL_PRE_FREQ_EPOCHS = 10
    PROBE_EPOCH0_EVAL_EPISODES = 20
    PROBE_LATE_N_DISC_RAMP_START_EPOCH = None
    PROBE_LATE_N_DISC_RAMP_END_EPOCH = None
    PROBE_SAFETY_RAMP_UNFREEZE_EPOCHS = 0
    PROBE_SAFETY_DECAY_RAMP_EPOCHS = 0
    PREDICTIVE_MERGE_INTENT_NORM_THRESHOLD = -0.05
    PREDICTIVE_TARGET_LANE_ACTIVATION_SLACK = 6.0
    PREDICTIVE_TARGET_LANE_BACKGROUND_WEIGHT = 0.3
    PREDICTIVE_TARGET_TTC_THW_WEIGHT = 0.6
    PREDICTIVE_TARGET_GAP_WEIGHT = 0.3
    PREDICTIVE_CURRENT_LANE_RISK_WEIGHT = 0.2
