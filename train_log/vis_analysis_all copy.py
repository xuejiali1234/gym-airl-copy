...
if __name__ == '__main__':
    ...
    csv_absolute_path = os.path.join(script_dir, 'baseline_attn_goal_safe_branch_aux_probe_P30_CPairD250_NoLateLR_Save1_Eval50_seed44_20260509_113618', 'progress.csv')
